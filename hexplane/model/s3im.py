...
class S3IM(torch.nn.Module):
    ...
    def forward(self, src_vec, tar_vec):
        ...
        #print("tar_all shape:", tar_all.shape)
        # src_vec=rendering['rgb'] (batch,1,1,3)  src_all(batch,1,1,3)
        # tar_vec=batch['rgb'][..., :3] (batch,1,1,3)  tar_all(batch,1,1,3)
        # repeat_time=10, patch_height=64, patch_width=64
